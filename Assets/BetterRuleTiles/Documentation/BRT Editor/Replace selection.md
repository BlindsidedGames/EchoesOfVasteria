...
Available on the [[Better Rule Tile Editor#The toolbar|toolbar]], the **replace selection** tool is a useful tool when you want to create a new set of rules using rules you've already created, or if you just want to replace sprites or tiles. With this tool, you can replace every tile/sprite with another tile/sprite in the selection you made with the [[Editor Tools#Selection tool|selection tool]].
