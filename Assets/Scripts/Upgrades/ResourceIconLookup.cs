...
namespace TimelessEchoes.Upgrades
{
    ...
    public static class ResourceIconLookup
    {
        ...
        private const int
            UnknownBlockStartIndex = 86; // First index of the unknown variants inside the same sprite asset

        private static readonly Dictionary<int, int> idToIndex;
        private static readonly Dictionary<int, int> idToUnknownIndex;
        ...
        /// </summary>
        public static TMP_SpriteAsset SpriteAsset { get; }
